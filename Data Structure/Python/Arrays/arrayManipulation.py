...
def array_manipulation(n, queries):
    ...
    maximum = array_manipulation_rec(i, initial_index, zero_array, queries)

    print(zero_array)
    return maximum

def array_manipulation_rec(i, initial_index, zero_array, queries):
    ...
    array_manipulation_rec(i, initial_index, zero_array, queries)
    return max(zero_array)
